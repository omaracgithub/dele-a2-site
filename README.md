# DELE A2 Marketing Site

Static marketing website for the DELE A2 Practice iOS app.

**Live at:** https://a2.prepdele.com
...
3. Add custom domain `a2.prepdele.com`
4. Add a CNAME DNS record pointing `a2.prepdele.com` to `omaracgithub.github.io`
